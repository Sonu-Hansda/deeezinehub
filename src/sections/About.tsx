...
export default function About() {
  return (
    <>
      <section className="bg-[#ebf0ea] pb-20 py-36">
        <div className="container mx-auto px-4 relative">
          <div className='flex items-baseline relative'>
            <h2 className="w-[20%] text-3xl md:text-4xl font-bold text-center mb-10">Know <span className='block font-findel'> About Us</span></h2>
